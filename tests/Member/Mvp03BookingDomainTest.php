...
final class Mvp03BookingDomainTest extends TestCase
{
    ...
    private function fixture(string $email, string $price, string $credit, string $start = '2030-01-10 03:00:00', string $end = '2030-01-10 04:00:00', int $quota = 5, string $code = 'SYNTHETIC'): array
    {
        ...
        DB::table('shift_schedules')->insert(['id' => $scheduleId, 'display_reference' => 'JAD-'.Str::upper(Str::random(8)), 'examination_site_id' => $siteId, 'service_offering_id' => $serviceId, 'starts_at' => $start, 'ends_at' => $end, 'quota' => $quota, 'status' => 'open', 'eligible_at' => null, 'created_at' => $now, 'updated_at' => $now]);
