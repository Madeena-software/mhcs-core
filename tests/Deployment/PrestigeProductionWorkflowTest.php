...
final class PrestigeProductionWorkflowTest extends TestCase
{
    public function test_prestige_production_workflow_is_manual_fail_closed_and_sanitized(): void
    {
        ...
        $this->assertStringContainsString('EXPECTED_REVISION="86a4c1210f19aed3b0d5482465a458687ab84350"', $workflow);
        $this->assertSame(1, substr_count($workflow, 'EXPECTED_REVISION="86a4c1210f19aed3b0d5482465a458687ab84350"'));
