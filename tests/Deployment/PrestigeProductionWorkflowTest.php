...
final class PrestigeProductionWorkflowTest extends TestCase
{
    public function test_prestige_production_workflow_is_manual_fail_closed_and_sanitized(): void
    {
        ...
        $this->assertStringContainsString('EXPECTED_REVISION="f3dbb053d0ed84a8a19e805233020dcdf410bffe"', $workflow);
        $this->assertSame(1, substr_count($workflow, 'EXPECTED_REVISION="f3dbb053d0ed84a8a19e805233020dcdf410bffe"'));
