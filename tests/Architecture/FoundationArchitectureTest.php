...
final class FoundationArchitectureTest extends TestCase
{
    ...
    public function test_no_module_business_implementation_or_business_migrations_exist(): void
    {
        ...
        $allowed = [
            ...
            '2026_08_13_000002_add_capture_metadata_to_image_gateway_capture_sets.php',
            ...
            '2026_09_07_000001_make_reusable_consent_instants_mysql_portable.php',
            '2026_09_07_000002_make_operator_claim_and_idempotency_instants_mysql_portable.php',
        ];
