...
final class PrestigeClinicSeederTest extends TestCase
{
    ...
    private function makeUnrelatedFixture(): array
    {
        ...
        DB::table('shift_schedules')->insert(['id' => $scheduleId, 'display_reference' => 'JAD-UNRELATED', 'examination_site_id' => $siteReferenceId, 'service_offering_id' => $offeringId, 'starts_at' => '2040-01-10 03:00:00', 'ends_at' => '2040-01-10 04:00:00', 'quota' => 1, 'status' => 'open', 'eligible_at' => $now, 'created_at' => $now, 'updated_at' => $now]);
