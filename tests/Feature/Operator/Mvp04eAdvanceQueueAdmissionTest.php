...
final class Mvp04eAdvanceQueueAdmissionTest extends TestCase
{
    ...
    public function test_worklist_is_fifo_and_uses_admission_id_as_stable_tie_breaker(): void
    {
        ...
        $this->assertSame(['admission_id', 'ticket_number', 'site_name', 'schedule_starts_at', 'schedule_ends_at', 'stage', 'state', 'ready_at', 'claimed_by_current_operator'], array_keys($entries[0]));
    }
