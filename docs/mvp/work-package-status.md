...
| WP-07 | Member clinical, consent, attendance, walk-in, and cash contracts | MEM-068..MEM-083, MEM-086..MEM-096, MEM-102..MEM-107, MEM-215, MEM-221..MEM-222 | The bounded Member attendance query and `confirmed` to `arrived` application contract are present for MVP-04; no clinical assessment, consent, walk-in, or cash workflow is present | MVP-04 and later | not-started | Entire package except the exact bounded attendance/arrival contract consumed by MVP-04 | This remains not-started as a Work Package; the narrow contract does not establish clinical workflow. |
...
| WP-12 | Operator attendance, basic examination, and queues | OPR-015..OPR-030, OPR-130..OPR-131 | Site-scoped attendance query, physical arrival, bounded Member transition, verification worklist, and bounded front-desk identity-verification case/decision flow are implemented; no check-in, consent, examination, ticket, or queue workflow is present | MVP-04 | partially-implemented | Remaining attendance, basic examination, and queue requirements | MVP-04B does not close WP-12 or advance a booking beyond `arrived`. |
