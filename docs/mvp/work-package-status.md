...
| WP-17 | Operator administration, contracts, and FHIR boundary | OPR-074..OPR-099, OPR-108..OPR-116, OPR-134, OPR-136, OPR-138 | Bounded Operator site, profile, site-assignment, eligible-shift, shift-assignment, arrival, and private paper-ticket resources plus local application contracts are implemented; FHIR and broader operational administration are absent | MVP-04/MVP-06 and later within Operator ownership | partially-implemented | Remaining contracts, FHIR, protocol, queue, ticket policy, and operational administration | The shared administrator interface may present Operator capabilities without owning Operator records or rules. |
