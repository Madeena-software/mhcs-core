...
| WP-07 | Member clinical, consent, attendance, walk-in, and cash contracts | MEM-068..MEM-083, MEM-086..MEM-096, MEM-102..MEM-107, MEM-215, MEM-221..MEM-222 | The bounded Member attendance/arrival contract and the MVP-04C Member-owned paper-consent confirmation contract are present; no clinical assessment, general consent administration, walk-in, or cash workflow is present | MVP-04 and later | not-started | Entire package except the exact bounded attendance/arrival and paper-consent contracts consumed by MVP-04 | This remains not-started as a Work Package; the narrow contracts do not establish clinical workflow or general consent capability. |
...
| WP-12 | Operator attendance, basic examination, and queues | OPR-015..OPR-030, OPR-130..OPR-131 | Site-scoped attendance query, physical arrival, bounded Member transition, verification worklist, identity-verification case/decision flow, and the bounded paper-consent confirmation flow are implemented; no check-in, examination, ticket, or queue workflow is present | MVP-04 | partially-implemented | Remaining attendance, basic examination, and queue requirements | MVP-04C does not close WP-12 or advance a booking beyond `arrived`. |
...
| WP-17 | Operator administration, contracts, and FHIR boundary | OPR-074..OPR-099, OPR-108..OPR-116, OPR-134, OPR-136, OPR-138 | Bounded Operator site, profile, site-assignment, eligible-shift, shift-assignment, and arrival resources plus local application contracts are implemented; FHIR and broader operational administration are absent | MVP-04/MVP-06 and later within Operator ownership | partially-implemented | Remaining contracts, FHIR, protocol, queue, and operational administration | The shared administrator interface may present Operator capabilities without owning Operator records or rules. |
